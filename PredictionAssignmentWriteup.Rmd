...
##Decision Tree Model
A decision tree model was used to predict the outcomes of the validation set and the prediction accurracy of this model was 85.37%. 
```{r cache=TRUE}
...
accuracy. But the performance was exactly the same as the our best model the Random Forests model.
```{r cache=TRUE}
## Combined Models
